# Contributing to Slim-config-detect-secrets
...
For patch contributions, see our [Developer Documentation](https://github.com/NASA-AMMOS/slim-config-detect-secrets/wiki) for more details on how to set up your local environment, to best contribute to our project. 
...
- [Issue tracking system](https://github.com/NASA-AMMOS/slim-config-detect-secrets/issues) - a regularly monitored area to report issues with our software or propose changes
- [Discussion board](https://github.com/NASA-AMMOS/slim-config-detect-secrets/discussions) - a permanently archived place to hold conversations related to our project, and to propose as well as show+tell topics to the contributor team. This resource can be searched for old discussions.
...
Make sure people are aware you're working on a patch! Check out our [issue tracking system](https://github.com/NASA-AMMOS/slim-config-detect-secrets/issues) and find an open issue you'd like to work against, or alternatively file a new issue and mention you're working on a patch.
...
See our list of issues at: https://github.com/NASA-AMMOS/slim-config-detect-secrets/issues
...
Take a look at our [issue tracking system](https://github.com/NASA-AMMOS/slim-config-detect-secrets/issues), and filter by `good first issue` for issues that are low-complexity, and that will help you get familiar with our issue tracking and patch submission process.

#### Suggesting New Issue Labels

Labels within our [issue tracking system](https://github.com/NASA-AMMOS/slim-config-detect-secrets/issues) are a great way to quickly sort through tickets. The project may not yet have labels to cover the full variety of issue tickets. Take a look through our list of issues, and if you notice a set of issue tickets that seem similar but are not categorized with an existing label, go ahead submit a request within one of the issues you've looked at with the following text:
...
- **Check for duplicates** - there may be a bug report already describing your issue, so check the [issue tracking system](https://github.com/NASA-AMMOS/slim-config-detect-secrets/issues) first.

Here's some guidance on submitting a bug issue:
1. Navigate to our [issue tracking system](https://github.com/NASA-AMMOS/slim-config-detect-secrets/issues) and file a new issue
...
- **Check for duplicates** - there may be a new feature issue already describing your issue, so check the [issue tracking system](https://github.com/NASA-AMMOS/slim-config-detect-secrets/issues) first
...
Take a look at our [pull requests tracking system](https://github.com/NASA-AMMOS/slim-config-detect-secrets/pulls), and try the following options for providing a review:
...
⚠️ It's **highly** advised that you take a look at our [issue tracking system](https://github.com/NASA-AMMOS/slim-config-detect-secrets/issues) before considering any code contributions. Here's some guidelines:
...
⚠️ It's **highly** advised that you take a look at our [issue-tracking system](https://github.com/NASA-AMMOS/slim-config-detect-secrets/issues) before considering any documentation contributions. Here's some guidelines:
...
- Hosted documentation
  - [Wiki Main-page](https://github.com/NASA-AMMOS/slim-config-detect-secrets/wiki)
- Discussion Boards
  - [Discussions](https://github.com/NASA-AMMOS/slim-config-detect-secrets/discussions)
...
- Answer open questions in our [discussion forum](https://github.com/NASA-AMMOS/slim-config-detect-secrets/discussions)
- Answer open questions mentioned in our [issue tracking system](https://github.com/NASA-AMMOS/slim-config-detect-secrets/issues)
